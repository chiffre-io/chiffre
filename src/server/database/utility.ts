...
export const setupUpdatedAtFieldAutoUpdate = (db: Knex) => {
  return db.raw(`
...
export const updatedAtFieldAutoUpdate = (db: Knex, tableName: string) => {
  return db.raw(`
...
export const setupBase64IdGenerator = (db: Knex) => {
  return db.raw(`
