import { b64, base64ToHex, hex, hexToBase64url, utf8 } from '@47ng/codec'
import srpClient from 'secure-remote-password/client'
import { pbkdf2DeriveBytes } from './primitives/pbkdf2'

/**
 * @param salt Hex string representation (N bytes, 2N characters)
 * @returns The private key in hexadecimal (32 bytes, 64 characters).
